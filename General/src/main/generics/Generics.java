...
import main.generics.genericClass.DoubleGenericClass;
import main.generics.genericClass.GenericBoundedBaseClass;
import main.generics.genericClass.GenericBoundedSubClass;
import main.generics.genericClass.GenericBoundedSuperClass;
import main.generics.genericClass.SingleGenericClass;
import main.generics.genericInterface.DoubleGenericImplementation;
import main.generics.genericInterface.DoubleGenericInterface;
import main.generics.genericInterface.SingleGenericImplementation;
import main.generics.genericInterface.SingleGenericInterface;
...
//		lowerBoundWildCard = subClass;	
	...
	public static void genericTypeMethodExamples() {
	...
	public static void genericBoundedTypeMethodExamples() {
...
//		genericMethod.combination1(superClass);
	...
	public static void multiBoundedTypeMethodExample() {
		GenericMethods genericMethod = new GenericMethods();
		/*In the 3 examples below, the specified class type is BaseClass, sub class type is SubClass and super class type is SuperClass.*/
		BaseClass baseClass = new BaseClass();
		SubClass subClass = new SubClass();
	...
	public static void genericBoundedClassExample() {
