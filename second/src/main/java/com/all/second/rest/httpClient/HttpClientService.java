...
public class HttpClientService implements InitializingBean {
	...
	public CommonResponseModel<?> getData() {
		HttpGet httpGet = new HttpGet(Constants.first_target_url);
		...
		return new CommonResponseModel<String>("Get Exception");
	}
	
	public CommonResponseModel<?> getUserData(String user) {
		HttpGet httpGet = new HttpGet(Constants.first_target_url + "/" + user);
		HttpHost httpHost = new HttpHost("http", "localhost", 8081);
	...
	public CommonResponseModel<?> postData(CommonRequestModel request) {
		...
		HttpPost httpPost = new HttpPost(Constants.first_target_url);
	...
	public CommonResponseModel<?> putData(CommonRequestModel request) {
		...
		HttpPut httpPut = new HttpPut(Constants.first_target_url);
		...
		return new CommonResponseModel<String>("Put Exception");
    }
	...
	public CommonResponseModel<?> patchData(CommonRequestModel request) {
		...
		HttpPatch httpPatch = new HttpPatch(Constants.first_target_url);
	...
	public CommonResponseModel<String> deleteData(CommonRequestModel request) {
		...
		HttpDelete httpDelete = new HttpDelete(Constants.first_target_url);
